...
import static Presentacion.frm_buscadmin.user_update;

/**
 *
 * @author bryan
 */
public class frm_busmesero extends javax.swing.JFrame {
    
  public static String user_update = "";
    /**
     * Creates new form frm_SearchWaiter
     */
    public frm_busmesero() {
        initComponents();
        ...
        tablaMeseros.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e){
                ...
                if (fila_point > -1) {
                    ...
                    frm_meserog me = new frm_meserog();
                    me.setVisible(true);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_busmesero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_busmesero().setVisible(true);
            }
        });
    }

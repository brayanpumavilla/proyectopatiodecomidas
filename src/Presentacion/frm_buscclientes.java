 ...
 * @author bryan
 */
public class frm_buscclientes extends javax.swing.JFrame {
        ...
        tablaClientes.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e){
                ...
                if (fila_point > -1) {
                    ...
                    frm_clienteg cl = new frm_clienteg();
                    cl.setVisible(true);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_buscclientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_buscclientes().setVisible(true);
            }
        });
    }

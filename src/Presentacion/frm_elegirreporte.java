 ...
 * @author vicra
 */
public class frm_elegirreporte extends javax.swing.JFrame {

    /**
     * Creates new form frm_elegirreporte
     */
    public frm_elegirreporte() {
        initComponents();
    ...
    private void initComponents() {
        ...
        cmbMesero.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-------------------------------------", "Reportes Ventas", "Reportes Compras" }));
        cmbMesero.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbMeseroActionPerformed(evt);
            }
        });
        getContentPane().add(cmbMesero, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 90, -1, -1));
    ...
    private void cmbMeseroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbMeseroActionPerformed
        ...
        if (cmb==2) {
            frm_reportetotal t =new frm_reportetotal();
            t.setVisible(true);
        }else if (cmb==3) {
            ReporteCompras b =new ReporteCompras();
            b.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_elegirreporte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_elegirreporte().setVisible(true);
            }
        });
    }

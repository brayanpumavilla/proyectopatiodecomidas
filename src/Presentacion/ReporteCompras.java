...
public class ReporteCompras extends javax.swing.JFrame {
    ...
    public ReporteCompras() {
        initComponents();
        setResizable(false);
        setTitle("Reportes Factura Compras");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, -1, 40));
    ...
    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton1ActionPerformed
        ...
        Facturacompras objEc=new Facturacompras();
        BD_REPORTES objNc= new BD_REPORTES();
        objEc.setFecha(fechames);
        rs=objNc.mostrarfaccomp(objEc); //rs contiene el resultado
        modelo.setColumnIdentifiers(new Object[] {"ID","fecha","monto"} );
        try {
            while (rs.next()) //inicia desde el primer elemento hasta el ultimo
            {
                modelo.addRow(new Object[]{rs.getString("idfaccompra"),rs.getString("fecha"),rs.getString("total")});
            }
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton2ActionPerformed
        ...
        BD_REPORTES objNc= new BD_REPORTES();
        objEc.setFecha(fechames);
        rs=objNc.mostrarfacomprdia(objEc); //rs contiene el resultado
        modelo.setColumnIdentifiers(new Object[] {"ID","fecha","monto"} );
        try {
            while (rs.next()) //inicia desde el primer elemento hasta el ultimo
            {

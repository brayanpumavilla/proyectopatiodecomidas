 ...
 * @author bryan
 */
public class frm_elegirclienteoimpr extends javax.swing.JFrame {

    /**
     * Creates new form frm_ChooseCustomersOption
     */
    public frm_elegirclienteoimpr() {
        initComponents();
    ...
    private void cmbMeseroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbMeseroActionPerformed
        ...
        if (cmb==2) {
            frm_buscclientes sw =new frm_buscclientes();
            sw.setVisible(true);
        }else if (cmb==3) {
           try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_elegirclienteoimpr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_elegirclienteoimpr().setVisible(true);
            }
        });
    }
